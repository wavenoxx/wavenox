...
export function Portfolio() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 pt-16 sm:px-8 md:pt-32">
        {/* Header */}
        <motion.div
