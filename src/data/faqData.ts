...
export const FAQ_DATA: FaqTopic[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. All WAVENOX residential installations utilize hybrid-ready inverters. You can install our low-profile solar roof today and seamlessly plug in an Omnigrid storage stack at any point in the future. Battery capacity can also be scaled modularly from 5 kWh up to 30 kWh as your family's evening consumption or EV charging requirements expand.",
    featured: false,
  },
